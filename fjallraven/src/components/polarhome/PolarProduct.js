...
import { langToMarket, langToURIUpper } from '../../config/utils';
import styles from '../../styles/home/trekkInSwedenSectionStyle.module.css';

const CurretedProd = ({ learnMore, productContent, productDatas }) => {
