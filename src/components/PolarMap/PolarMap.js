...
import MapZoomButton from '../../../src/components/map/mapZoomButton';
...
const PolarMap = ({ singleEventRoute }) => {
  ...
  const createMap = () => {
    return new mapboxgl.Map({
      ...
      style: Config.mapboxWinterStyle,
  ...
  const updateMap = () => {
    ...
    map.current.setStyle(Config.mapboxWinterStyle);
    map.current.easeTo({
      center: currentMapData.center,
