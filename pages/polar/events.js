...
import { getCookieValue, langToURI, uriToLang } from '../../src/config/utils';
import { getMenuItems, getPeopleStatesList } from '../../src/services/sanity';
...
Events.getInitialProps = async function (context) {
  ...
  const query = groq`*[_type == "polarPagesListing" && _id=="eventPolarListing"]`;
